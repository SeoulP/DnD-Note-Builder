...
class: Fighter
species: ""
effect: If you hit a creature with a Lance, you can force it to make a Con. saving throw (DC 8 + 2 + the ability modifier used to make the attack). On a failed save, the creature has the Prone condition.
save: (DC 8 + 2 + the ability modifier used to make the attack)
trigger: Hit a creature with a Lance
action: None / Passive
level: 1
---

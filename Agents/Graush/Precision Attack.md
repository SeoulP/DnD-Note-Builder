...
class: ""
species: ""
effect: When you miss with an attack roll, you can expend one Superiority Die, roll that die, and add it to the attack roll, potentially causing it to hit.
action: None / Passive
trigger: Miss an attack

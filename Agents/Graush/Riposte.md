...
species: ""
action: Reaction
effect: When a creature misses you with a melee attack, you can take a Reaction and expend one Superiority Die to make a melee attack with a weapon or an Unarmed Strike against the creature. If you hit, add the Superiority Die to the attack's damage.

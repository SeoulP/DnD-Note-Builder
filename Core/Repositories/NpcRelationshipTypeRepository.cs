...
namespace DndBuilder.Core.Repositories
{
    public class NpcRelationshipTypeRepository
    {
        ...
        public void Migrate()
        {
            ...
            hasInactive.CommandText = "SELECT COUNT(*) FROM pragma_table_info('npc_relationship_types') WHERE name = 'inactive'";
        ...
        public List<NpcRelationshipType> GetAll(int campaignId)
        {
            ...
            var cmd  = _conn.CreateCommand();
            cmd.CommandText = "SELECT id, campaign_id, name, description FROM npc_relationship_types WHERE campaign_id = @cid AND inactive = 0 ORDER BY name ASC";
        ...
        {
            var cmd = _conn.CreateCommand();
            cmd.CommandText = "UPDATE npc_relationship_types SET inactive = 1 WHERE id = @id";

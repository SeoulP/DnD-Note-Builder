...
{
    public class DnD5eItemRepository
    {
        private readonly SqliteConnection _conn;

        public DnD5eItemRepository(SqliteConnection conn)
        {
            _conn = conn;
        }
        ...
        public void Migrate()
        {
            ...
            // system_items — bridge between DnD5eItem and game-system mechanics
        ...
        public List<DnD5eItem> GetAll(int campaignId)
        {
            var list = new List<DnD5eItem>();
            var cmd  = _conn.CreateCommand();
        ...
        public void Edit(DnD5eItem item)
        {
            var cmd = _conn.CreateCommand();
        ...
        private static void Bind(SqliteCommand cmd, DnD5eItem i)
        {
        ...
        private static DnD5eItem Map(SqliteDataReader r) => new DnD5eItem
        {
            Id          = r.GetInt32(0),

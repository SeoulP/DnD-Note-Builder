...
{
    public class DnD5eEncounterRepository
    {
        private readonly SqliteConnection _conn;

        public DnD5eEncounterRepository(SqliteConnection conn) => _conn = conn;
        ...
        public int Add(DnD5eEncounter e)
        {
            var cmd = _conn.CreateCommand();
        ...
        public void Edit(DnD5eEncounter e)
        {
            var cmd = _conn.CreateCommand();
        ...
        public DnD5eEncounter Get(int id)
        {
            var cmd = _conn.CreateCommand();
        ...
        public List<DnD5eEncounter> GetAll(int campaignId)
        {
            var list = new List<DnD5eEncounter>();
            var cmd = _conn.CreateCommand();
        ...
        public List<DnD5eEncounter> GetBySession(int sessionId)
        {
            var list = new List<DnD5eEncounter>();
            var cmd = _conn.CreateCommand();
        ...
        private static DnD5eEncounter Map(SqliteDataReader r) => new DnD5eEncounter
        {
            Id         = r.GetInt32(0),

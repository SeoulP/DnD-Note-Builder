...
{
    public class DnD5eCharacterRelationshipTypeRepository
    {
        private readonly SqliteConnection _conn;

        public DnD5eCharacterRelationshipTypeRepository(SqliteConnection conn)
        {
            _conn = conn;
        }
        ...
        public List<DnD5eCharacterRelationshipType> GetAll(int campaignId)
        {
            var list = new List<DnD5eCharacterRelationshipType>();
            var cmd  = _conn.CreateCommand();
            ...
            while (reader.Read())
                list.Add(new DnD5eCharacterRelationshipType
                {
        ...
        public int Add(DnD5eCharacterRelationshipType t)
        {
            var cmd = _conn.CreateCommand();

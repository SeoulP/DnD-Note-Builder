...
{
    public class DnD5eItemTypeRepository
    {
        private readonly SqliteConnection _conn;

        public DnD5eItemTypeRepository(SqliteConnection conn)
        {
            _conn = conn;
        }
        ...
        public List<DnD5eItemType> GetAll(int campaignId)
        {
            var list = new List<DnD5eItemType>();
            var cmd  = _conn.CreateCommand();
        ...
        public int Add(DnD5eItemType type)
        {
            var cmd = _conn.CreateCommand();

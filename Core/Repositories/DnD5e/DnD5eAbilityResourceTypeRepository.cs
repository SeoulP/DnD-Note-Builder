...
{
    public class DnD5eAbilityResourceTypeRepository
    {
        private readonly SqliteConnection _conn;

        public DnD5eAbilityResourceTypeRepository(SqliteConnection conn)
        {
            _conn = conn;
        }
        ...
        public List<DnD5eAbilityResourceType> GetAll(int campaignId)
        {
            var list = new List<DnD5eAbilityResourceType>();
            var cmd  = _conn.CreateCommand();
        ...
        public int Add(DnD5eAbilityResourceType type)
        {
            var cmd = _conn.CreateCommand();
        ...
        public void Edit(DnD5eAbilityResourceType type)
        {
            var cmd = _conn.CreateCommand();
        ...
        private static DnD5eAbilityResourceType Map(System.Data.Common.DbDataReader r) => new DnD5eAbilityResourceType
        {
            Id                 = r.GetInt32(0),

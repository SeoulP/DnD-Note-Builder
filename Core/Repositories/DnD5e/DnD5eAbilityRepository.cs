...
{
    public class DnD5eAbilityRepository
    {
        private readonly SqliteConnection _conn;

        public DnD5eAbilityRepository(SqliteConnection conn) => _conn = conn;
        ...
        public List<DnD5eAbility> GetAll(int campaignId)
        {
            var list = new List<DnD5eAbility>();
            var cmd  = _conn.CreateCommand();
        ...
        public DnD5eAbility Get(int id)
        {
            var cmd = _conn.CreateCommand();
            cmd.CommandText = @"SELECT id, campaign_id, name, type, action, trigger, recovery, effect, notes, sort_order, max_choices, choice_pool_type, recovery_interval, recovery_amount, pick_count_mode, choice_count_base, choice_count_attribute, choice_count_add_prof, choice_count_add_level, type_id
        ...
        public int Add(DnD5eAbility ability)
        {
            var cmd = _conn.CreateCommand();
        ...
        public void Edit(DnD5eAbility ability)
        {
            var cmd = _conn.CreateCommand();
        ...
        // ── DnD5eClass level ability links ─────────────────────────────────────────
        ...
        public List<DnD5eCharacterAbility> GetCharacterAbilities(int characterId)
        {
            var list = new List<DnD5eCharacterAbility>();
            var cmd  = _conn.CreateCommand();
            cmd.CommandText = "SELECT character_id, ability_id, source FROM character_abilities WHERE character_id = @cid";
            cmd.Parameters.AddWithValue("@cid", characterId);
            using var reader = cmd.ExecuteReader();
            while (reader.Read())
                list.Add(new DnD5eCharacterAbility
                {
        ...
        public List<DnD5eCharacterAbilityChoice> GetCharacterAbilityChoices(int characterId, int abilityId)
        {
            var list = new List<DnD5eCharacterAbilityChoice>();
            var cmd = _conn.CreateCommand();
            ...
            while (reader.Read())
            {
                list.Add(new DnD5eCharacterAbilityChoice
                {
                    CharacterId = reader.GetInt32(0),
                    AbilityId = reader.GetInt32(1),
        ...
        public List<DnD5eAbilityChoiceProgression> GetChoiceProgressionForAbility(int abilityId)
        {
            var list = new List<DnD5eAbilityChoiceProgression>();
            var cmd = _conn.CreateCommand();
            ...
            while (reader.Read())
            {
                list.Add(new DnD5eAbilityChoiceProgression
                {
        ...
        public int AddChoiceProgression(DnD5eAbilityChoiceProgression progression)
        {
            var cmd = _conn.CreateCommand();
        ...
        public void EditChoiceProgression(DnD5eAbilityChoiceProgression progression)
        {
            var cmd = _conn.CreateCommand();
        ...
        public int ResolveChoiceCount(DnD5eAbility ability, int characterLevel, DnD5ePlayerCharacter pc = null)
        {
            int picks;
        ...
        public List<DnD5eAbilityUsageProgression> GetUsageProgressionForAbility(int abilityId)
        {
            var list = new List<DnD5eAbilityUsageProgression>();
            var cmd  = _conn.CreateCommand();
            ...
            using var reader = cmd.ExecuteReader();
            while (reader.Read())
                list.Add(new DnD5eAbilityUsageProgression
                {
                    Id            = reader.GetInt32(0),
                    AbilityId     = reader.GetInt32(1),
                    RequiredLevel = reader.GetInt32(2),
        ...
        public void AddUsageProgression(DnD5eAbilityUsageProgression entry)
        {
            var cmd = _conn.CreateCommand();
        ...
        private static int GetScore(DnD5ePlayerCharacter pc, string attr) => attr switch
        {
            "str" => pc.Strength,
            "dex" => pc.Dexterity,
            "con" => pc.Constitution,
        ...
        private static void Bind(SqliteCommand cmd, DnD5eAbility a)
        {
        ...
        private static DnD5eAbility Map(SqliteDataReader r) => new DnD5eAbility
        {
            Id               = r.GetInt32(0),
        ...
        // ── DnD5eAbility costs CRUD ────────────────────────────────────────────────

        public List<DnD5eAbilityCost> GetCosts(int abilityId)
        {
            var list = new List<DnD5eAbilityCost>();
            var cmd  = _conn.CreateCommand();
        ...
        public void AddCost(DnD5eAbilityCost cost)
        {
            var cmd = _conn.CreateCommand();
        ...
        // ── DnD5eAbility Choices CRUD ──────────────────────────────────────────────

        public List<DnD5eAbilityChoice> GetChoicesForAbility(int abilityId)
        {
            var list = new List<DnD5eAbilityChoice>();
            var cmd  = _conn.CreateCommand();
            ...
            using var reader = cmd.ExecuteReader();
            while (reader.Read())
                list.Add(new DnD5eAbilityChoice
                {
                    Id              = reader.GetInt32(0),
                    AbilityId       = reader.GetInt32(1),
        ...
        public int AddChoice(DnD5eAbilityChoice choice)
        {
            var cmd = _conn.CreateCommand();
        ...
        public void EditChoice(DnD5eAbilityChoice choice)
        {
            var cmd = _conn.CreateCommand();

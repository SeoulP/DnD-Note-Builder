...
{
    public class DnD5eClassRepository
    {
        private readonly SqliteConnection _conn;

        public DnD5eClassRepository(SqliteConnection conn) => _conn = conn;
        ...
        public List<DnD5eClass> GetAll(int campaignId)
        {
            var list = new List<DnD5eClass>();
            var cmd  = _conn.CreateCommand();
        ...
        public void Edit(DnD5eClass cls)
        {
            var cmd = _conn.CreateCommand();
        ...
        public List<DnD5eSubclass> GetSubclassesForClass(int classId)
        {
            var list = new List<DnD5eSubclass>();
            var cmd  = _conn.CreateCommand();
        ...
        public List<DnD5eSubclass> GetAllSubclasses(int campaignId)
        {
            var list = new List<DnD5eSubclass>();
            var cmd  = _conn.CreateCommand();
        ...
        public DnD5eSubclass GetSubclass(int id)
        {
            var cmd = _conn.CreateCommand();
            cmd.CommandText = @"SELECT id, campaign_id, class_id, name, description, notes, sort_order
        ...
        public int AddSubclass(DnD5eSubclass sub)
        {
            var cmd = _conn.CreateCommand();
        ...
        public void EditSubclass(DnD5eSubclass sub)
        {
            var cmd = _conn.CreateCommand();
        ...
        public List<DnD5eClassLevel> GetLevelsForClass(int classId)
        {
            var list = new List<DnD5eClassLevel>();
            var cmd  = _conn.CreateCommand();
        ...
        public void SaveLevel(DnD5eClassLevel lvl)
        {
            var cmd = _conn.CreateCommand();
            if (lvl.Id == 0)
            {
        ...
        private static void BindClass(SqliteCommand cmd, DnD5eClass c)
        {
        ...
        private static void BindSubclass(SqliteCommand cmd, DnD5eSubclass s)
        {
        ...
        private static DnD5eClass MapClass(SqliteDataReader r) => new DnD5eClass
        {
            Id                  = r.GetInt32(0),
        ...
        private static DnD5eSubclass MapSubclass(SqliteDataReader r) => new DnD5eSubclass
        {
            Id          = r.GetInt32(0),
            CampaignId  = r.GetInt32(1),
        ...
        private static DnD5eClassLevel MapLevel(SqliteDataReader r) => new DnD5eClassLevel
        {
            Id        = r.GetInt32(0),

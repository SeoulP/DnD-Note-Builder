...
namespace DndBuilder.Core.Models
{
    public class DnD5eAbility
    {
        ...
        // Loaded on demand
        public List<DnD5eAbilityCost>            Costs            { get; set; } = new();
        public List<DnD5eAbilityChoice>          Choices          { get; set; } = new();
        public List<DnD5eAbilityChoiceProgression> ChoiceProgression { get; set; } = new();
    }
}
